...
System.register(['lib/OofA.js', 'lib/DataSet.js', 'lib/util.js', 'node_modules/lzma/src/lzma_worker.js', 'node_modules/pako/dist/pako.js'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      const ds = new DataSet(2, 3, new Uint8Array([0, 1, 2, 3, 4, 5])); /* eslint no-console: 0 */
      ...
      util.mergeObject(window, { ds, du, ctx, ds22, ds33, dseast, dssouth, ds10f, ds10i });
