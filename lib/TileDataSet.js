...
System.register(['lib/util.js', 'lib/DataSet.js', 'lib/RgbImageDataSet.js'], function (_export, _context) {
  var util, DataSet, RgbImageDataSet;
  return {
    setters: [function (_libUtilJs) {
      util = _libUtilJs.default;
    }, function (_libDataSetJs) {
      DataSet = _libDataSetJs.default;
    }, function (_libRgbImageDataSetJs) {
      RgbImageDataSet = _libRgbImageDataSetJs.default;
    }],
    execute: function () {
      //
