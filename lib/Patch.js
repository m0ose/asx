...
System.register(['./Color.js'], function (_export, _context) {
  var Color;
  return {
    ...
    execute: function () {
      ...
      const PatchProto = {
        ...
        set color(typedColor) {
          return this.setColor(typedColor);
        },
