    ...
    execute: function () {
      ...
      const Color = {
        ...
        toTypedColor(any) {
          ...
          if (util.isInteger(any)) tc.setPixel(any);else if (Array.isArray(any) || util.isTypedArray(any)) tc.setColor(...any);else if (typeof any === 'string') tc.setCss(any);else util.error('toTypedColor: invalid argument');
          return tc;
        },
