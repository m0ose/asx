    ...
    execute: function () {
      ...
      class FireModel extends Model {
        ...
        spreadRateLeaflet80(slopeAngle) {
          ...
          if (slopeAngle < 0) slopeCorrectionFactor = Math.pow(2, -(slopeAngle / 10)) / (Math.pow(2, 1 - slopeAngle / 10) - 1);else slopeCorrectionFactor = Math.exp(0.069 * slopeAngle);
