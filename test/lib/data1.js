System.register(['lib/DataSet.js', 'lib/RGBDataSet.js', 'lib/util.js', 'etc/lzma.js', 'etc/lzma_worker.js', 'node_modules/pako/dist/pako.min.js'], function (_export, _context) {
  "use strict";

  var DataSet, RGBDataSet, util, LZMA, lzma, pako;
  return {
    ...
    }, function (_etcLzma_workerJs) {
      lzma = _etcLzma_workerJs.default;
    }, function (_node_modulesPakoDistPakoMinJs) {
      pako = _node_modulesPakoDistPakoMinJs.default;
    }],
    execute: function () {
      ...
      const typedArray = util.repeat(1e6, (i, a) => {
        a[i] = i;
      }, new Uint8Array(1e6));
      ...
      function* main() {
        ...
        let pixels = !useImg ? typedArray : png24 ? new RGBDataSet(img).data : util.imageToBytes(img, true);
