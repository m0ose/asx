    ...
    execute: function () {
      ...
      const ColorMap = {
        ...
        typedArrayToTypedColors(typedArray) {
          const array = [];
          util.step(typedArray.length, 4, i => array.push(Color.typedColor(typedArray.subarray(i, i + 4))));
        ...
        permuteArrays(A1, A2 = A1, A3 = A1) {
          const array = [];
          for (let a1 of A1) for (let a2 of A2) for (let a3 of A3) array.push([a1, a2, a3]);
          return array;
        },
