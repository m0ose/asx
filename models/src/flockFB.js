// run with http://localhost/Documents/asx/models/index.html?src/flockFB
...
class FlockModel extends Model {
  ...
  setup () {
    ...
    this.turtles.setDefault('speed', 0.15)
    ...
    this.setMaxTurn(3.0)
    this.setVision(3)
    this.minSeparation = 0.2
    // this.anim.setRate(30)
    this.population = 150 // 300 // 1e4 this.patches.length
